...
class ViewController2: UIViewController{
    ...
    @IBOutlet weak var mudarButton: UIButton!
    ...
    @IBAction func votarButtonClicked(_ sender: Any){
        ...
        if (vezes == 0){
            ...
            databaseReference.child("ios").child("concursos").child("reis").child("votos").child("1Rodolpho").childByAutoId().setValue(ratingStackView.starsRating)
            vezes += 1;
        }
        else{
